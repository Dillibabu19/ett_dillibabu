            ...
            <tbody>
                ...
                try {
                    ...
                    while (val1.next()) {
                        ...
                        out.println("<td>");
                        out.println("<a href='emp_task_ud?account=" + val1.getInt(1) + "&val=u'>Update</a>");
                        out.println("</td>");
                        out.println("<td>");
                        out.println("<a href='emp_task_ud?account=" + val1.getInt(1) + "&val=d'>delete</a>");
                        out.println("</td>");
                        out.println("</tr>");
                    }
                } catch (Exception e) {
